...
import static com.example.mymusicplayer.MainActivity.ARTIST_TO_FRAG;
import static com.example.mymusicplayer.MainActivity.PATH_TO_FRAG;
import static com.example.mymusicplayer.MainActivity.SHOW_MINI_PLAYER;
import static com.example.mymusicplayer.MainActivity.SONG_NAME_TO_FRAG;
                        ...
                        if(SHOW_MINI_PLAYER) {
                            if (PATH_TO_FRAG != null) {
                                ...
                                if(art!=null) {
                                    ...
                                    Glide.with(getContext()).load(R.drawable.notfound)
                                            .into(albumArt);
                                }
